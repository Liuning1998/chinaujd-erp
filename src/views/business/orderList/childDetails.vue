	...
	<div class="container">
			...
			<div class="floor">
				...
				<el-row>
					...
					<el-col :span="8">
						...
						<span v-if="form.orderstatus">{{ JSON.parse(form.orderstatus).desc }}</span>
					</el-col>
					<el-col :span="8">
		...
		<div class="floor">
			...
			<div class="tableList">
				<el-table :data="form.orderItems"
					...
					<el-table-column label="单位">枚</el-table-column>
					<el-table-column label="数量">1</el-table-column>
					<el-table-column label="操作">
						<template slot-scope="scope">
							<el-link v-if="![0].includes(form.orderstatus)" type="primary" :underline="false"
		...
		<el-dialog title="订单详情" :visible.sync="detailsAlert" width="640px" class="details">
			<div style="height: 400px; overflow: auto;">
				<Details :orderStampId="orderItemId"></Details>
			</div>
		</el-dialog>
	</div>
</template>
